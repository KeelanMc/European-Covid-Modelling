####################################################################################################
###
### File:    Our_model_fit.R
### Purpose: Fitting SEIR models to each European countries daily covid case data, fit the GAM via a Bayesian framework as outlined in
...
allcountries = read_csv("Original_data/Provided_data/owid-covid-data.csv")
